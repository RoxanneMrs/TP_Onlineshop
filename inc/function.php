...
function pagination($pdo, $URLparam, $sqlTxt, $nbrOfElemenColumn, $numberElemPerPage)
{   
    ...
    $nbArticles = (int) $result[$nbrOfElemenColumn];

    // On détermine le nombre d'articles par page
    $parPage = $numberElemPerPage;
    ...
    $elemForPagination = ["nbArticles" => $nbArticles, "pages" => $pages, "premier" => $premier, "currentPage" => $currentPage];
